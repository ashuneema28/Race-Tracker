...
//Test when Active object
    ...
    public void testStartAndStop() throws Exception {
        ...
        TrackingServer trackingServer1 = new TrackingServer(12003);
        DummyMessageProcessor processor1 = new DummyMessageProcessor("A",trackingServer1);
        comm1.setProcessor(processor1);
        comm1.start();

        Communicator comm2 = new Communicator();
        TrackingServer trackingServer2 = new TrackingServer(12004);
        DummyMessageProcessor processor2 = new DummyMessageProcessor("B",trackingServer2);
